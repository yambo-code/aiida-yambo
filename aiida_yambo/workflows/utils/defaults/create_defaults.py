...
def create_quantumespresso_inputs(structure, bands_gw=None, spin_orbit=False, what = ['scf','nscf']):
    ...
    scf['SYSTEM']['nbnd'] = Z_valence + 10
    nscf['SYSTEM']['nbnd'] = bands_gw
