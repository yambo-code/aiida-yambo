...
calculation_set_yambo ={'resources':  {"num_machines": 8,"num_mpiprocs_per_machine": 32}, 'max_wallclock_seconds': 3*60*60, 
                  'max_memory_kb': 1*92*1000000 ,  'custom_scheduler_commands': u"#PBS -A  Pra14_3622" ,
                  'environment_variables': {"OMP_NUM_THREADS": "2" }  }
...
if __name__ == "__main__":
    """
    HOW TO:
    1. Add the contents of   ../wf  to your   aiida/workflows/user/cnr_nano  directory.
    2. Add your structure to AiiDA (sample structure exists in the same folder as this file).
    3. Add your pseudopotentials to AiiDA
    4. Add your codes (pw, yambo, p2y) to AiiDA
    Run as Follows on your terminal

        $ verdi run  test_full.py   --precode p2y@marcknl --yambocode yambo@marcknl  --pwcode qe61@marcknl  --pseudo CHtest --structure  1791
