...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        help=
        ' prexisitng inputfile to parse for parameters, structure and kpoints '
    )
    parser.add_argument(
        '--nscfinput',
        type=str,
    ...
    if not args.structure:
        if args.scfinput:
            pw_parameters, structure, kpoints = read_from_pw_inp(
                filename=args.scfinput)
        if args.nscfinput:
            pw_nscf_parameters, structure, kpoints = read_from_pw_inp(
                filename=args.scfinput)
    else:
